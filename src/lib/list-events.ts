 ...
 */
export async function listEvents(theme: string): Promise<ListedEvent[]> {
    ...
    input: [
      {
        ...
        content: [
          ...
          "Return 8 to 12 distinct events when the theme allows it.",
        ].join(" "),
      },
  ...
  return parsed.events.slice(0, 12);
}
