...
export const stories = pgTable("stories", {
  ...
  scriptStatus: text("script_status").default("none").notNull(),
  scriptHook: text("script_hook"),
  scriptSegments: jsonb("script_segments").$type<Array<{ heading: string; narration: string; sourceIds: string[] }>>().default([]),
  scriptClosingLine: text("script_closing_line"),
  scriptDisclaimer: text("script_disclaimer"),
  scriptWordCount: integer("script_word_count").default(0).notNull(),
  scriptGeneratedAt: timestamp("script_generated_at", { withTimezone: true }),
